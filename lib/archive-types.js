...
/** @typedef {z.infer<typeof ArchiveUser>} */
...
/** @typedef {z.infer<typeof ArchiveUsers>} */
const ArchiveUsers = z.array(ArchiveUser)

/** @typedef {z.infer<typeof ArchiveContact>} */
...
/** @typedef {z.infer<typeof ArchiveContacts>} */
const ArchiveContacts = z.array(ArchiveContact)

/** @typedef {z.infer<typeof ArchiveEnterprise>} */
...
/** @typedef {z.infer<typeof ArchiveEnterprises>} */
const ArchiveEnterprises = z.array(ArchiveEnterprise)

/** @typedef {z.infer<typeof ArchiveDocument>} */
const ArchiveDocument = z.object({
  ...
  JournalDate: z.iso.datetime({ local: true }).nullable(),
  Category: z.object({
    Recno: z.number(),
    Code: z.string(),
...
/** @typedef {z.infer<typeof ArchiveDocuments>} */
